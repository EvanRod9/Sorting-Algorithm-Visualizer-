...
public class QuickSortVisualizer extends JPanel {
    ...
    public QuickSortVisualizer(int width, int height, int size) {
    ...
    private void animateSwap(int index1, int index2) throws InterruptedException {
        highlightedIndex = Math.max(index1, index2);
        paintNow();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Quick Sort Visualizer + Sound");
            QuickSortVisualizer panel = new QuickSortVisualizer(1400, 700, 400);
